function [w] = L1General2_PSSG0(funObj,w,lambda,options)
...
[verbose,optTol,progTol,maxIter,suffDec,corrections,Dtype,quadraticInit] = ...
    ...
    'maxIter',50,'suffDec',1e-4,'corrections',100,'Dtype',1,'quadraticInit',0);
...
for i = 1:maxIter
    ...
    if i == 1
        ...
        % Find updates where curvature condition was satisfied on working set
